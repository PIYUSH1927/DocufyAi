        ...
        {[
          {
            ...
            features: ["AI-Generated Docs (Limited)",
          ...
          },
          {
            ...
            features: ["AI-Generated Docs (Unlimited)",
          ...
          <motion.div key={index} className="pricing-card"  whileHover={{ scale: 1.05 }}>
            <h2>{plan.title}</h2>
            ...
            <motion.button whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }} className="pricing-btn">
              Get Started
            </motion.button>
            <br />
          </motion.div>
